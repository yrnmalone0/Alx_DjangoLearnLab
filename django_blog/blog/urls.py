...
urlpatterns = [
    ...
    path('post/<int:pk>/comments/edit/', CommentUpdateView.as_view(), name="edit-comment"),
    path('post/<int:pk>/comments/delete/', CommentDeleteView.as_view(), name="delete-comment"),
]